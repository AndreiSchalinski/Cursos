		...
		<div class="conteudo" >
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Prioridade">
					<select name="" id="" v-model="prioridade">
						<option v-for="(prioridade,i) in prioridades" :key="i" :value="prioridade.codigo" :selected="prioridade.codigo === 1">{{ prioridade.codigo }} - {{ prioridade.nome }}</option>
					</select>
				</Rotulo>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Marque as Opções">
					<span>
						<ul v-for="(c,i) in caracteristicas" :key="i">
							<li>{{ c }}</li>
						</ul>
					</span>
				</Rotulo>
